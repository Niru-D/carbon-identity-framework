...
public class SQLQueries {
    ...
    public static final String GET_PAP_POLICY_SQL = "SELECT POLICY_ID, VERSION, LAST_MODIFIED_TIME, " +
            "LAST_MODIFIED_USER, IS_ACTIVE, POLICY_ORDER, POLICY_TYPE, POLICY_EDITOR, POLICY FROM IDN_XACML_POLICY " +
            "WHERE IS_IN_PAP = ? AND TENANT_ID = ? AND POLICY_ID=? AND VERSION =(SELECT MAX(VERSION) FROM " +
            "IDN_XACML_POLICY WHERE POLICY_ID = ? AND TENANT_ID=?)";
    ...
    public static final String GET_PAP_POLICY_SET_REFS_SQL = "SELECT SET_REFERENCE FROM IDN_XACML_POLICY_SET_REFERENCE" +
    ...
    public static final String GET_PAP_POLICY_EDITOR_DATA_SQL = "SELECT NAME, DATA FROM IDN_XACML_POLICY_EDITOR_DATA " +
            "WHERE POLICY_ID=? AND VERSION=? AND TENANT_ID=?";

    public static final String GET_PAP_POLICY_META_DATA_SQL = "SELECT NAME, VALUE FROM IDN_XACML_POLICY_ATTRIBUTE " +
            "WHERE POLICY_ID=? AND VERSION=? AND TENANT_ID=?";

    public static final String GET_PAP_POLICY_BY_VERSION_SQL = "SELECT LAST_MODIFIED_TIME, LAST_MODIFIED_USER, " +
            "IS_ACTIVE, POLICY_ORDER, POLICY_TYPE, POLICY_EDITOR, POLICY FROM IDN_XACML_POLICY WHERE IS_IN_PAP = ? " +
    ...
    public static final String GET_ALL_PAP_POLICIES_SQL = "SELECT t1.POLICY_ID, t1.VERSION, t1.LAST_MODIFIED_TIME, " +
            "t1.LAST_MODIFIED_USER, t1.IS_ACTIVE, t1.POLICY_ORDER, t1.POLICY_TYPE, t1.POLICY_EDITOR FROM " +
            "IDN_XACML_POLICY t1 WHERE t1.IS_IN_PAP = ? AND t1.TENANT_ID = ? AND t1.VERSION =(SELECT MAX(VERSION) " +
            "FROM IDN_XACML_POLICY t2 WHERE t2.POLICY_ID = t1.POLICY_ID AND t2.TENANT_ID=?)";
    ...
    public static final String GET_POLICY_PDP_PRESENCE_SQL = "SELECT POLICY_ID FROM IDN_XACML_POLICY WHERE " +
            "POLICY_ID=? AND IS_IN_PDP=? AND TENANT_ID=?";

    public static final String GET_PDP_POLICY_SQL = "SELECT POLICY, POLICY_ORDER, IS_ACTIVE, POLICY_TYPE, VERSION " +
            "FROM IDN_XACML_POLICY WHERE POLICY_ID=? AND IS_IN_PDP=? AND TENANT_ID=?";

    public static final String GET_PDP_POLICY_DATA_SQL = "SELECT POLICY_ORDER, IS_ACTIVE, POLICY_TYPE FROM " +
            "IDN_XACML_POLICY WHERE POLICY_ID=? AND IS_IN_PDP=? AND TENANT_ID=?";

    public static final String GET_POLICY_PDP_PRESENCE_BY_VERSION_SQL = "SELECT POLICY_ID FROM IDN_XACML_POLICY " +
            "WHERE POLICY_ID=? AND IS_IN_PDP=? AND TENANT_ID=? AND VERSION=?";

    public static final String GET_ALL_PDP_POLICIES_SQL = "SELECT POLICY, POLICY_ORDER, IS_ACTIVE, POLICY_TYPE, " +
            "VERSION FROM IDN_XACML_POLICY WHERE TENANT_ID=? AND IS_IN_PDP=?";

    public static final String GET_ALL_PDP_POLICY_DATA_SQL = "SELECT POLICY_ID, POLICY_ORDER, IS_ACTIVE, POLICY_TYPE " +
            "FROM IDN_XACML_POLICY WHERE TENANT_ID=? AND IS_IN_PDP=?";
    ...
    public static final String GET_ACTIVE_STATUS_AND_ORDER_SQL = "SELECT IS_ACTIVE, POLICY_ORDER FROM " +
            "IDN_XACML_POLICY WHERE POLICY_ID=? AND TENANT_ID=? AND IS_IN_PDP=?";
    ...
    public static final String GET_POLICY_STATUS_SQL = "SELECT POLICY_ID, TYPE, SUCCESS, USER, TARGET, " +
            "TARGET_ACTION, TIME_INSTANCE, MESSAGE, POLICY_VERSION FROM IDN_XACML_STATUS WHERE POLICY_ID=? AND " +
            "POLICY_TENANT_ID=?";

    public static final String GET_SUBSCRIBER_STATUS_SQL = "SELECT SUBSCRIBER_ID, TYPE, SUCCESS, USER, TARGET, " +
            "TARGET_ACTION, TIME_INSTANCE, MESSAGE, POLICY_VERSION FROM IDN_XACML_STATUS WHERE SUBSCRIBER_ID=? " +
